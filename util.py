...
ANY_LIC = 'Either Free Copilot Chat (no extra license) OR M365 Copilot license'
...
DESC_RESEARCHER = 'Reasoning agent in Microsoft 365 Copilot Chat \u2014 access via m365.cloud.microsoft/chat > Agents > Researcher. Two demo modes to highlight: (1) \ud83d\udd0d Critique Mode \u2014 Researcher self-critiques every source, verifying claims against the originals before including them in the report. (2) \u2696\ufe0f Model Council \u2014 Researcher orchestrates multiple frontier reasoning models (GPT-5, Claude Opus, Claude Sonnet 4.7) to debate the brief, surface dissent, and synthesise a balanced answer. Grounded in live web + your tenant data with citations. Requires M365 Copilot license.'
