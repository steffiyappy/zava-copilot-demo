...
ANY_ACCT = 'Free: Sasha Ouellet \u2014 SashaO@ABSx62256373.OnMicrosoft.com  \u2022  M365: MOD Administrator \u2014 admin@ABSx62256373.onmicrosoft.com'
FREE_LIC = 'Free \u2014 no Microsoft 365 Copilot license needed'
M365_LIC = 'Microsoft 365 Copilot'
ANY_LIC = 'Either Free Copilot Chat (no extra license) OR Microsoft 365 Copilot license'
FRONTIER_LIC = 'Microsoft 365 Copilot + Frontier Program'
...
DESC_RESEARCHER = 'Reasoning agent in Microsoft 365 Copilot Chat \u2014 access via m365.cloud.microsoft/chat > Agents > Researcher. Two demo modes to highlight: (1) \ud83d\udd0d Critique Mode \u2014 Researcher self-critiques every source, verifying claims against the originals before including them in the report. (2) \u2696\ufe0f Model Council \u2014 Researcher orchestrates multiple frontier reasoning models (GPT and Claude) to debate the brief, surface dissent, and synthesise a balanced answer. Grounded in live web + your tenant data with citations. Requires Microsoft 365 Copilot license.'
...
DESC_WORD = 'Copilot inside Word for the Web. Open a .docx > Copilot pane. Two demo angles: (1) inline \"Edit with Copilot\" agent mode that rewrites, restructures or expands sections of the document in one instruction \u2014 great for board minutes/briefs; (2) draft new sections grounded in /reference files. Requires Microsoft 365 Copilot license.'
DESC_PPT = 'Copilot inside PowerPoint for the Web. Open a .pptx > Copilot pane. Two demo angles: (1) inline \"Edit with Copilot\" agent mode that restyles/restructures the deck, generates speaker notes, swaps imagery; (2) generate new slides grounded in /reference files. Requires Microsoft 365 Copilot license.'
DESC_OUTLOOK = 'Copilot inside Outlook on the Web. Two demo angles: (1) summarise long threads + draft replies grounded in tenant context; (2) coach my writing for tone, clarity and stakeholder fit. Requires Microsoft 365 Copilot license.'
DESC_TEAMS = 'For this demo we use Copilot grounded in the Teams Recap on the demo tenant for one of four meetings: "New Software Implementation", "Potential Merger", "Negotiating Marketing Contract", or "Marketing Campaign Performance Review". Workflow: Open the meeting in your Teams calendar > the Recap page opens with AI Notes, chapters, transcript and action items > click the Copilot icon in the top right of the Recap page > Copilot opens grounded in the meeting transcript > type your minutes prompt > copy the structured output into a new Word document (or open Microsoft 365 Copilot Chat with a /transcript reference and ask Copilot to produce a .docx). Note: Teams Recap has no Export to Word button \u2014 the workflow is Copilot pane > copy/paste OR Microsoft 365 Copilot Chat. Requires Microsoft 365 Copilot license + Teams Premium for full Recap features.'
...
DESC_COWORK = 'Cowork is the autonomous agent in Microsoft 365 Copilot \u2014 access via m365.cloud.microsoft > left nav > Agents > Cowork. ONE prompt that delegates 5 parallel tasks: draft a Word doc, draft a second Word doc, send an email, schedule a calendar meeting, and post a Teams message \u2014 Cowork executes them all and reports back. Requires Microsoft 365 Copilot + Frontier Program enrollment.'
DESC_WORD_AGT = 'Word Agent in Microsoft 365 Copilot Chat \u2014 do NOT open Word first. From m365.cloud.microsoft/chat type a prompt with /reference files context describing the document you want, and Copilot returns a fully drafted .docx you can open in Word. Great for: board minutes, briefing memos, policy drafts, status reports. Works in BOTH the free Copilot Chat tier (Sasha account) AND with an Microsoft 365 Copilot license (MOD Admin account).'
DESC_PPT_AGT = 'PowerPoint Agent in Microsoft 365 Copilot Chat \u2014 do NOT open PowerPoint first. From m365.cloud.microsoft/chat type a prompt with /reference files context describing the deck you want (theme, audience, slide list), and Copilot returns a complete .pptx you can open in PowerPoint. Great for: Board decks, IR decks, town hall decks. Works in BOTH the free Copilot Chat tier (Sasha account) AND with an Microsoft 365 Copilot license (MOD Admin account).'
DESC_XL_AGT = 'Excel Agent in Microsoft 365 Copilot Chat \u2014 do NOT open Excel first. From m365.cloud.microsoft/chat type a prompt with /reference files context describing the workbook you want (sheets, columns, charts, conditional formatting), and Copilot returns a fully built .xlsx you can open in Excel. Great for: KPI dashboards, division comparisons, scenario models. Works in BOTH the free Copilot Chat tier (Sasha account) AND with an Microsoft 365 Copilot license (MOD Admin account).'
