...
T_SCOUT = '🧭 Microsoft Scout (Frontier preview)'
T_SHAREPOINT = '🌐 AI in SharePoint'
T_CREATE = '🎨 Copilot Create (image · poster · infographic · video)'
