...
SECTORS = [
    {"id": "sec-banking",    "label": "Banking",          "industries": ["ind-commercial-banking","ind-islamic-banking","ind-investment-banking"]},
    {"id": "sec-insurance",  "label": "Insurance",         "industries": ["ind-general-insurance","ind-life-insurance","ind-takaful"]},
    {"id": "sec-fintech",    "label": "Fintech",           "industries": ["ind-fintech"]},
    {"id": "sec-healthcare", "label": "Healthcare",        "industries": ["ind-hospital","ind-pharma"]},
    {"id": "sec-og",         "label": "Oil & Gas",         "industries": ["ind-og-upstream","ind-og-downstream"]},
    {"id": "sec-energy",     "label": "Energy",            "industries": ["ind-renewable"]},
    {"id": "sec-mfg",        "label": "Manufacturing",     "industries": ["ind-industrial-mfg","ind-construction"]},
    {"id": "sec-agri",       "label": "Agriculture",       "industries": ["ind-plantation"]},
    {"id": "sec-bpo",        "label": "BPO & Tech",        "industries": ["ind-bpo"]},
    {"id": "sec-telco",      "label": "Telco",             "industries": ["ind-telco"]},
    {"id": "sec-congl",      "label": "Conglomerate",      "industries": ["ind-conglomerate"]},
    {"id": "sec-govt",       "label": "Government",        "industries": ["ind-govt","ind-regulator"]},
    {"id": "sec-glc",        "label": "GLC",               "industries": ["ind-glc"]},
    {"id": "sec-re",         "label": "Real Estate",       "industries": ["ind-property-reit"]},
    {"id": "sec-logistics",  "label": "Logistics",         "industries": ["ind-logistics"]},
    {"id": "sec-aviation",   "label": "Aviation",          "industries": ["ind-aviation"]},
    {"id": "sec-mining",     "label": "Mining",            "industries": ["ind-coal-mining"]},
    {"id": "sec-retail",     "label": "Retail",            "industries": ["ind-retail-grocery"]},
    {"id": "sec-hospitality","label": "Hospitality",       "industries": ["ind-hotel"]},
    {"id": "sec-media",      "label": "Media",             "industries": ["ind-media"]},
    {"id": "sec-general",    "label": "General",           "industries": ["ind-general"]},
]
