...
ARCHETYPE_BY_ID = {
    ...
    'cosmetics':                ('dashboard', 'Cosmetics Brand-House KPI Dashboard',
        'brand share by house · live-shopping GMV · BPOM Notifikasi expiries · SKU margin · recall status',
        '/COSMETICS_01_BPOM_Notifikasi_Tracker.xlsx', 'Cosmetics & Personal Care'),
