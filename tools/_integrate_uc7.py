...
Tandai setiap asumsi [ASSUMPTION:...]. Tidak boleh ada angka karangan. Format: Word doc 1 halaman. ''' + MARKER
...
Tag every assumption [ASSUMPTION:...]. No fabricated numbers. Format: 1-page Word doc. ''' + MARKER
...
Tandai setiap asumsi [ASSUMPTION:...]. Jangan mengada-ada angka KPI — pakai apa yang ada di workbook. ''' + MARKER
...
Tag every assumption [ASSUMPTION:...]. Do not fabricate KPI numbers — use what is in the workbook. ''' + MARKER
...
Tandai setiap asumsi [ASSUMPTION:...]. Tone: percaya diri, food-first, tidak boleh rasis atau tone-deaf terhadap audiens Muslim Indonesia. ''' + MARKER
...
Tag every assumption [ASSUMPTION:...]. Tone: confident, food-first, never racist or tone-deaf to the Indonesian Muslim audience. ''' + MARKER
...
Tandai setiap asumsi [ASSUMPTION:...]. Gunakan terminologi mining-services yang presisi (Mbcm, strip ratio, OEE, TKDN, TRIR). Jangan mengada-ada riwayat project. ''' + MARKER
...
def integrate_one(file_path: Path, ind_id: str, tool_type: str,
    ...
    if MARKER in text and prompt_en[-50:] in text:
        return False, f"already integrated (marker found): {file_path.name} :: {ind_id} :: {tool_type}"
