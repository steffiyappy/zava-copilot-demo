...
BI_ONLY_IN_BM = [
    ...
    'membutuhkan', 'kebijakan', 'jadwal', 'tabel', 'tahap',
    'tahapan', 'mengelola', 'pengelolaan', 'manajer', 'menyajikan',
    'mengeluarkan', 'pengeluaran', 'anak perusahaan', 'menyelenggarakan',
...
BM_ONLY_IN_BI = [
    ...
    'meluluskan', 'diluluskan', 'dikemaskini', 'terkini', 'sekejap',
