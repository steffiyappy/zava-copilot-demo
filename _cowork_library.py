...
ENTRY_USE_CASES = {
    ...
    'dept-risk':                ['uc-property-opr-shock', 'uc-ib-brc-prep', 'uc-risk-appetite', 'uc-board-pack', 'uc-incident-pmortem', 'uc-fintech-fraud'],
    'dept-strategy':            ['uc-property-land-bank', 'uc-property-strategic-landscape', 'uc-property-gm-strategy-deck', 'uc-klk-q1-ops-review', 'uc-strat-marketscan', 'uc-cong-capalloc', 'uc-board-pack', 'uc-town-hall'],
    'dept-marketing':           ['uc-life-corporate-renewal', 'uc-life-pitch-brief', 'uc-property-create-infographic', 'uc-marketing-campaign', 'uc-media-campaign', 'uc-board-pack', 'uc-town-hall'],
