...
ENTRY_USE_CASES = {
    ...
    'general-insurance':        ['uc-insurance-claims-modernisation', 'uc-cga-multi-lob-claims-tat', 'uc-cga-raid-heatmap', 'uc-cga-autonomous-raid-digest', 'uc-life-empathetic-claim-reply', 'uc-life-plain-language-clause', 'uc-genins-cat-claim', 'uc-board-pack', 'uc-incident-pmortem', 'uc-fin-monthend'],
    ...
    'hospital-network':         ['uc-audit-group-risk-consolidation', 'uc-audit-horizon-scan-fy27', 'uc-hospital-caseconf', 'uc-board-pack', 'uc-it-incident', 'uc-town-hall'],
    'pharmaceutical':           ['uc-audit-group-risk-consolidation', 'uc-audit-horizon-scan-fy27', 'uc-pharma-regsubmission', 'uc-board-pack', 'uc-incident-pmortem', 'uc-fin-monthend'],
    ...
    'renewable-energy':         ['uc-geo-ppa-compliance', 'uc-renewable-ppa', 'uc-board-pack', 'uc-incident-pmortem', 'uc-esg-disclosure'],
    ...
    'government-agency':        ['uc-integrity-taskforce-response', 'uc-govt-parlq', 'uc-board-pack', 'uc-town-hall', 'uc-it-incident'],
    'financial-regulator':      ['uc-integrity-taskforce-response', 'uc-reg-supervisory', 'uc-board-pack', 'uc-incident-pmortem', 'uc-town-hall'],
    ...
    'dept-risk':                ['uc-audit-group-risk-consolidation', 'uc-audit-horizon-scan-fy27', 'uc-tobacco-cht-tax-shock', 'uc-bev-ssb-tax-shock', 'uc-property-opr-shock', 'uc-ib-brc-prep', 'uc-risk-appetite', 'uc-board-pack', 'uc-incident-pmortem', 'uc-fintech-fraud'],
    ...
    'dept-marketing':           ['uc-qsr-lebaran-promo', 'uc-bev-create-infographic', 'uc-life-corporate-renewal', 'uc-life-pitch-brief', 'uc-property-create-infographic', 'uc-marketing-campaign', 'uc-media-campaign', 'uc-board-pack', 'uc-town-hall'],
    'dept-esg':                 ['uc-geo-ppa-compliance', 'uc-aster-esg-workflow', 'uc-esg-disclosure', 'uc-plantation-rspo', 'uc-board-pack', 'uc-renewable-ppa'],
