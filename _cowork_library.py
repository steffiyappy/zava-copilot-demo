...
ENTRY_USE_CASES = {
    ...
    'life-insurance':           ['uc-life-claims-tat-benchmark', 'uc-life-corporate-renewal', 'uc-lifeins-persistency', 'uc-board-pack', 'uc-fin-monthend', 'uc-town-hall'],
    ...
    'property-reit':            ['uc-property-township-ops-review', 'uc-reit-renewal', 'uc-board-pack', 'uc-fin-monthend', 'uc-ir-invday'],
    ...
    'property-development':     ['uc-property-township-ops-review', 'uc-property-land-bank', 'uc-propdev-launch', 'uc-construction-vo', 'uc-board-pack', 'uc-marketing-campaign'],
    ...
    'dept-strategy':            ['uc-property-land-bank', 'uc-klk-q1-ops-review', 'uc-strat-marketscan', 'uc-cong-capalloc', 'uc-board-pack', 'uc-town-hall'],
    'dept-marketing':           ['uc-life-corporate-renewal', 'uc-marketing-campaign', 'uc-media-campaign', 'uc-board-pack', 'uc-town-hall'],
    'dept-esg':                 ['uc-aster-esg-workflow', 'uc-esg-disclosure', 'uc-plantation-rspo', 'uc-board-pack', 'uc-renewable-ppa'],
    'dept-operations':          ['uc-life-claims-tat-benchmark', 'uc-property-township-ops-review', 'uc-ops-sop', 'uc-board-pack', 'uc-incident-pmortem', 'uc-it-incident'],
