...
ENTRY_USE_CASES = {
    ...
    'general-insurance':        ['uc-cga-multi-lob-claims-tat', 'uc-cga-raid-heatmap', 'uc-cga-autonomous-raid-digest', 'uc-life-empathetic-claim-reply', 'uc-life-plain-language-clause', 'uc-genins-cat-claim', 'uc-board-pack', 'uc-incident-pmortem', 'uc-fin-monthend'],
    ...
    'coal-mining':              ['uc-coal-merger-recap', 'uc-coal-volume', 'uc-board-pack', 'uc-incident-pmortem', 'uc-esg-disclosure'],
    ...
    'dept-strategy':            ['uc-coal-merger-recap', 'uc-bev-strategic-landscape', 'uc-bev-ssb-tax-shock', 'uc-property-land-bank', 'uc-property-strategic-landscape', 'uc-property-gm-strategy-deck', 'uc-klk-q1-ops-review', 'uc-strat-marketscan', 'uc-cong-capalloc', 'uc-board-pack', 'uc-town-hall'],
    ...
    'dept-operations':          ['uc-cga-multi-lob-claims-tat', 'uc-cga-raid-heatmap', 'uc-life-claims-tat-benchmark', 'uc-life-empathetic-claim-reply', 'uc-life-ops-agent', 'uc-property-township-ops-review', 'uc-ops-sop', 'uc-board-pack', 'uc-incident-pmortem', 'uc-it-incident'],
