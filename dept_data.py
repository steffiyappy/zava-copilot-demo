...
# ── FINANCE ───────────────────────────────────────────────────────────────
ind('dept-finance','department','Finance & Treasury','💰','#1B5E20','#2E7D32',
    'Zava Group Holdings — Group Finance Division',
    'MYR 18.4B net debt, FOREX hedging 11 currencies, NPL breach remediation, REIT IPO structuring.',
    'The Group Finance Division manages group treasury, reporting, tax, and investor relations. Net debt is MYR 18.4B at 0.82x gearing. FOREX exposure spans MYR, IDR, USD, SGD, INR, and 6 other currencies. Group CFO Hadar Caspit is preparing the FY2025 half-year results, the REIT IPO financial model, and the BNM remediation plan for Zava Bank.',
...
print(f"Departments written: {len(DEPARTMENTS)} entries")
