...
INDUSTRIES_12.append(ind(
    ...
    [
      ...
      personaID=['Mod Admin'],
      notebookMeta={
        'sources':['/ECM_01_GMV_Cohort_Tracker.xlsx','/ECM_02_Rider_Supply_Heatmap.xlsx','/ECM_05_Festive_Peak_Operations_Playbook.docx'],
    ...
    relevantDepts=['dept-strategy','dept-operations','dept-finance','dept-legal','dept-marketing','dept-it-cybersec'],
    personas=[
...
INDUSTRIES_12.append(ind(
    ...
    [
      ...
      personaID=['Mod Admin'],
      notebookMeta={
        'sources':['/MAR_01_IMO_2030_Fleet_Capex.xlsx','/MAR_02_Container_Charter_Rates_Tracker.xlsx','/MAR_05_Fleet_Renewal_Financing_Playbook.docx'],
    ...
    relevantDepts=['dept-strategy','dept-operations','dept-finance','dept-legal','dept-procurement','dept-it-cybersec'],
    personas=[
