...
const _UI = {
  ...
  // Subsidiaries chip strip (entry hero)
  '📌 Real ASEAN subsidiaries we mapped here (from your account list)':
                           ['📌 Anak perusahaan ASEAN nyata yang kami petakan di sini (dari daftar akun Anda)',
                            '📌 Anak syarikat ASEAN sebenar yang kami petakan di sini (daripada senarai akaun anda)'],
