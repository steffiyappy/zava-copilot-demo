...
<nav class="topbar">
  ...
  <div class="topbar-right">
    <div class="lang-toggle" id="lang-toggle">
      <button class="lang-btn active" id="lang-en" onclick="setLang('EN')" title="English">&#127468;&#127463; EN</button>
      <button class="lang-btn" id="lang-id" onclick="setLang('ID')" title="Bahasa Indonesia">&#127470;&#127465; ID</button>
