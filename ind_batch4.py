...
ind('og-downstream','og-energy','Oil & Gas — Downstream','🏭','#BF360C','#D84315',
    'HengYuan Refining Sdn Bhd',
    'Refinery margin at USD 4.2/bbl — DOSH CIMAH audit in 8 weeks.',
    ...
    ['OG_01_Nusantara_Energy.xlsx','OG_02_Nusantara_HSE_Report.docx'],
    [
...
# ── RENEWABLE ENERGY ───────────────────────────────────────────────────────
ind('renewable-energy','og-energy','Renewable Energy','☀','#F9A825','#F57F17',
    'GreenPower Division (Sarawak Energy)',
    '480MW solar pipeline + PPA renegotiation with Tenaga — EUETS carbon credit filing due.',
    'GreenPower Division manages Sarawak Energy\'s 2.4GW hydro portfolio and a 480MW solar pipeline under development. The power purchase agreement (PPA) with Tenaga Nasional Berhad (TNB) for 800MW is up for renegotiation. Carbon credit generation under Verra VCS is being certified. The Energy Commission (ST) large-scale solar (LSS) bid is due in 6 weeks.',
    ['OG_01_Nusantara_Energy.xlsx','20_Zava_ESG_Sustainability_Framework.docx'],
    [
      tool(T_CHAT, FREE_LIC, FREE_ACCT, [
...
ind('industrial-manufacturing','manufacturing','Industrial Manufacturing','⚙','#263238','#37474F',
    'Zava Manufacturing (Nilai Plant)',
    'OEE 62% — spindle motor failures, 2,800-unit backlog MYR 14.2M. SIRIM audit in 8 weeks.',
    'Zava Manufacturing\'s Nilai plant produces precision industrial components for the automotive and electronics sectors. Overall Equipment Effectiveness (OEE) has dropped from 76% to 62% over 3 quarters, driven by recurring spindle motor failures on 3 of 12 CNC machines. A 2,800-unit production backlog worth MYR 14.2M has accumulated. SIRIM ISO 9001:2015 audit is scheduled in 8 weeks.',
    ['12_Zava_Manufacturing_KPIs.xlsx','21_Zava_Chemical_Safety_HIRARC.docx'],
    [
      tool(T_CHAT, FREE_LIC, FREE_ACCT, [
